...
class Disc(models.Model):
    artist = models.CharField("Artisti", max_length = 50)
    name = models.CharField("Levyn nimi", max_length = 50)
...
class Owner(models.Model):
    name = models.CharField("Nimi", max_length = 50)
...
class Track(models.Model):
    artist = models.CharField("Artisti", max_length = 50)
    name = models.CharField("Kappaleen nimi", max_length = 50)
    disc = models.ForeignKey(Disc, unique = False, default = 1, blank = True, null = True)
    def __unicode__(self):
      return unicode(self.artist+" - "+self.name)

class Wish(models.Model):
    source = models.CharField("Toivoja", max_length= 50)
